...
impl RenderTaskTree {
    ...
    pub fn generate_passes(
        ...
        for &cacheable_task in &self.cacheable_render_tasks {
    ...
    /// Assign the render tasks from the tree rooted at main_render_task to the `passes`
    /// vector, so that the passes that we depend on end up _earlier_ in the pass
    /// list.
    fn generate_passes_impl(
        &self,
        root_task: RenderTaskId,
        screen_size: DeviceIntSize,
        gpu_supports_fast_clears: bool,
...
fn link(
    ...
    if simple_path {
        write!(output,
            r#"<path d="M {} {} C {} {} {} {} {} {}" style="fill:none;stroke:rgb(100, 100, 100);stroke-width:3px;"/>"#,
            x1, y1,
            mid_x, y1,
            mid_x, y2,
            x2, y2,
        ...
        let ctrl_y = y1 - 25.0;
        write!(output,
            r#"<path d="M {} {} C {} {} {} {} {} {} C {} {} {} {} {} {}" style="fill:none;stroke:rgb(100, 100, 100);stroke-width:3px;" />"#,
            x1, y1,
            ctrl1_x, y1,
            ctrl1_x, ctrl_y,
            mid_x, ctrl_y,
